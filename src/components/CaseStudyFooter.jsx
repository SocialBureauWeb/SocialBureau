  ...
  return (
    <section className="bg-black text-center py-30 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <button className="bg-red-600 hover:bg-red-700 transition-colors text-white font-semibold text-base py-3 px-6 rounded-full inline-flex items-center gap-2">
          <FaCalendarAlt />
