...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed bottom-0 left-0 w-full bg-[rgba(0,0,0,0.3)] text-white px-6 py-4 flex items-center justify-between transition-opacity duration-500 ${
    ...
    >
      ...
      <ul className="hidden md:flex gap-8">
        <li className="hover:text-red-500 hover:font-bold"><a href="#">Home</a></li>
        <li className="hover:text-red-500 hover:font-bold"><a href="#">Services</a></li>
        <li className="hover:text-red-500 hover:font-bold"><a href="#">About</a></li>
